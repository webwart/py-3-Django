...
>SP: Upgrade python in an environment [YTVID](https://www.youtube.com/watcch?v=y6xdIumaEy4)
...
-1- Created this document - I created the folder earlier, this year when I started to work on deployment in on Digital Ocean.

-2- Django in Enterprise article iX. - I downloaded the code and documents from this article. [Christian Leubner, 1.12.2020 iX](/https://www.heise.de/ratgeber/Django-Erweiterungen-Anwendungen-unternehmenstauglich-machen-mit-wenig-Aufwand-4970925.html)
